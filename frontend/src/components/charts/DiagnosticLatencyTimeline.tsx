...
const DiagnosticLatencyTimeline: React.FC<DiagnosticLatencyTimelineProps> = ({ data }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', padding: '1rem 0' }}>
      ...
      {/* diagnostic timeline */}
      <div>
        <h4 style={{ margin: '0 0 1rem 0', fontSize: '0.875rem', color: isDark ? '#f1f5f9' : '#0f172a' }}>
        ...
        >
          {/* Step 1: Sintomas */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1, minWidth: '80px' }}>
            <div
              style={{
                width: '32px',
                height: '32px',
            ...
            <span style={{ fontSize: '0.75rem', fontWeight: 600, marginTop: '0.5rem', color: isDark ? '#e2e8f0' : '#334155' }}>
              Sintomas
            </span>
            <span style={{ fontSize: '0.675rem', color: '#94a3b8', marginTop: '0.125rem' }}>Dia 0.0</span>
          </div>

          {/* Connector 1 */}
          <div style={{ flex: 1, height: '4px', background: '#e2e8f0', margin: '0 10px', position: 'relative', minWidth: '40px' }}>
            <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', fontSize: '0.75rem', fontWeight: 'bold', color: '#0f766e' }}>
          ...
          {/* Connector 2 */}
          <div style={{ flex: 1, height: '4px', background: '#e2e8f0', margin: '0 10px', position: 'relative', minWidth: '40px' }}>
            <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', fontSize: '0.75rem', fontWeight: 'bold', color: '#0d9488' }}>
          ...
          {/* Connector 3 */}
          <div style={{ flex: 1, height: '4px', background: '#e2e8f0', margin: '0 10px', position: 'relative', minWidth: '40px' }}>
            <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', fontSize: '0.75rem', fontWeight: 'bold', color: '#06b6d4' }}>
      ...
      <div>
        ...
        >
          ...
          {/* Connector */}
          <div style={{ flex: 1, height: '4px', background: '#e2e8f0', margin: '0 10px', position: 'relative', minWidth: '80px' }}>
            <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', fontSize: '0.75rem', fontWeight: 'bold', color: '#ea580c' }}>
