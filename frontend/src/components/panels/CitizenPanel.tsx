...
const CitizenPanel: React.FC<CitizenPanelProps> = ({
  ...
  return (
    <div className="stack">
          ...
          <div className="panel" style={{ padding: '1rem' }}>
            <div className="section-header">
              <div>
                ...
                <p className="meta">
                  Comparação de gravidade (Cura vs UTI vs Óbito) por perfil gestacional.
                </p>
              </div>
            </div>
      ...
      <section className="panel" style={{ marginTop: '1.5rem', padding: '1.5rem' }}>
        ...
        <div className="citizen-proportional-grid">
          <div style={{ textAlign: 'center' }}>
            <p
              className="meta"
              style={{ marginBottom: '0.5rem', fontWeight: 600, color: 'var(--text-main)' }}
            >
              Escolaridade
            </p>
      ...
      <article className="panel" style={{ marginTop: '3rem' }}>
        <div className="section-header">
          <h3>Assinatura Clínica de Sintomas</h3>
        </div>
        <div className="symptoms-signature-wrap">
          {symptomsSignature && (
