...
const CitizenPanel: React.FC<CitizenPanelProps> = ({
  ...
  return (
    <div className="stack">
      ...
      <p className="meta">Comparativo de sintomas entre COVID-19, Influenza e VSR.</p>
      ...
      <h3>Perfil de Imunização (COVID-19 e Gripe)</h3>
      <p className="meta">Comparação proporcional do esquema vacinal no grupo selecionado.</p>
      <div className="chart-wrap" style={{ height: '350px' }}>
        <VaccinationProfileChart vaccinationData={vaccination} />
      </div>

      <h3>Curva de Proteção Vacinal (Kaplan-Meier)</h3>
      ...
      <div className="section-header" style={{ marginTop: '30px', borderTop: '1px solid #f1f5f9', paddingTop: '20px' }}>
      ...
      <p className="meta">Atraso médio (mediana) entre a última dose e o início dos sintomas para cada coorte.</p>
