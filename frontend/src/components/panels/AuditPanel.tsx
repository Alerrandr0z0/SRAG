  ...
  return (
    <div className="stack" style={{ gap: '2rem' }}>
      <header>
        ...
        <p className="sub">
          Percentual de campos preenchidos e válidos (não ignorados) na base SIVEP-Gripe.
        </p>
      </header>
              ...
              {group.fields.map((field) => (
                <div key={field.field}>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 700, color: getScoreColor(field.rate) }}>
                      {field.rate}%
                    </span>
                  </div>
                  <div
      ...
      <article className="panel" style={{ background: '#f8fafc', border: '1px dashed #cbd5e1' }}>
        ...
        <p style={{ margin: 0, fontSize: '13px', color: '#64748b', lineHeight: 1.6 }}>
          A completude é calculada como a razão entre registros com valores válidos e o total de
          casos filtrados. Valores como "Ignorado" (geralmente código 9), strings vazias ou nulos
          são considerados dados incompletos. Uma alta completude (acima de 90%) é essencial para
          análises epidemiológicas confiáveis.
        </p>
      </article>
    </div>
  );
