...
export function buildDonutItems<T extends { label: string; count: number }>(
  data: T[],
  colors: string[],
) {
...
export function formatNotificationDelayTooltip(params: Array<{ name?: string } & TooltipPoint>) {
