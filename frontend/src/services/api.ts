...
export const api = {
  ...
  fetchHospitalizationDuration: (
    ...
    fetchJson<Epi.HospitalizationDurationData>(
      withFilters(
  ...
  fetchSeverityKpis: (
    ...
    fetchJson<Epi.SeverityKpisResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.SEVERITY_KPIS}`,
        p,
        r,
        g,
        z,
  ...
  fetchSeasonalTrends: (
    ...
    fetchJson<Epi.SeasonalTrendsResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.SEASONAL_TRENDS}`,
        p,
        r,
        g,
        z,
  ...
  fetchSeverityPyramid: (
    ...
    fetchJson<Epi.SeverityPyramidResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.SEVERITY_PYRAMID}`,
        p,
        r,
        g,
        z,
  ...
  fetchGravityCascade: (
    ...
    fetchJson<Epi.GravityCascadeResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.GRAVITY_CASCADE}`,
        p,
        r,
        g,
        z,
  ...
  fetchHeatmapSeAge: (
    ...
    fetchJson<Epi.EpidemicHeatmapResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.HEATMAP_SE_AGE}`,
        p,
        r,
        g,
        z,
  ...
  fetchComorbiditiesTreemap: (
    ...
    fetchJson<Epi.ComorbiditiesTreemapResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.COMORBIDITIES_TREEMAP}`,
        p,
        r,
        g,
        z,
  ...
  fetchVentilatorySupport: (
    ...
    fetchJson<Epi.VentilatorySupportResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.VENTILATORY_SUPPORT}`,
        p,
        r,
        g,
        z,
  ...
  fetchDiagnosticResilience: (
    ...
    fetchJson<Epi.DiagnosticResilienceResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.DIAGNOSTIC_RESILIENCE}`,
        p,
        r,
        g,
        z,
  ...
  fetchNosocomialRisk: (
    ...
    fetchJson<Epi.NosocomialRiskResponse>(
      withFilters(
        `${API_BASE}${API_ENDPOINTS.NOSOCOMIAL_RISK}`,
        p,
        r,
        g,
        z,
